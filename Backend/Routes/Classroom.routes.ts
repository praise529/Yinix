...
import { Add_Classroom, AddStudentToClassroom, GetALLClassrooms, Get_Classroom, SendClassStream, CreateClassStream } from "../Controllers/Classroom.controller";
...
Classroom_Router.post("/:ID/Stream", CreateClassStream);
